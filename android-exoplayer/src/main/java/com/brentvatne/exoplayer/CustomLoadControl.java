...
public class CustomLoadControl implements LoadControl {
    ...
    public static final class Builder {
         ...
         */
        public CustomLoadControl.Builder setAllocator(DefaultAllocator allocator) {
         ...
         * @throws IllegalStateException If {@link #createDefaultLoadControl()} has already been called.
         */
        public CustomLoadControl.Builder setBufferDurationsMs(
                int minBufferMs,
                int maxBufferMs,
         ...
         * @throws IllegalStateException If {@link #createDefaultLoadControl()} has already been called.
         */
        public CustomLoadControl.Builder setTargetBufferBytes(int targetBufferBytes) {
            Assertions.checkState(!createDefaultLoadControlCalled);
         ...
         * @throws IllegalStateException If {@link #createDefaultLoadControl()} has already been called.
         */
        public CustomLoadControl.Builder setPrioritizeTimeOverSizeThresholds(boolean prioritizeTimeOverSizeThresholds) {
            Assertions.checkState(!createDefaultLoadControlCalled);
         ...
         * @throws IllegalStateException If {@link #createDefaultLoadControl()} has already been called.
         */
        public CustomLoadControl.Builder setBackBuffer(int backBufferDurationMs, boolean retainBackBufferFromKeyframe) {
            Assertions.checkState(!createDefaultLoadControlCalled);
    ...
    /** @deprecated Use {@link CustomLoadControl.Builder} instead. */
    @Deprecated
    ...
    public boolean shouldContinueLoading(long bufferedDurationUs, float playbackSpeed) {
        ...
        Log.d("CustomLoadControl",
                ...
                " shouldContinueLoading: " + isBuffering);
